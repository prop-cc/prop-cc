...
//  The original source file is "..\..\..\app\willard\phase1.pcc".
///////////////////////////////////////////////////////////////////////////////
...
//
///////////////////////////////////////////////////////////////////////////////
#line 27 "../../../app/willard/phase1.pcc"
#line 95 "../../../app/willard/phase1.pcc"
///////////////////////////////////////////////////////////////////////////////
//
...
#else
static const char * Phase1_file_name = "..\..\..\app\willard\phase1.pcc";
#endif
...
#line 95 "../../../app/willard/phase1.pcc"
    ...
    {
#line 94 "../../../app/willard/phase1.pcc"
...
#line 94 "../../../app/willard/phase1.pcc"
    ...
    case 41: {
#line 93 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Or(EXISTS(_EXISTS(redex)->_1,_EXISTS(redex)->_2,_OP(_EXISTS(redex)->_3)->_2->_1),EXISTS(_EXISTS(redex)->_1,_EXISTS(redex)->_2,_OP(_EXISTS(redex)->_3)->_2->_2->_1)),redex,Phase1_file_name,93,"EXISTS (x, S, OP (\"or\", #[f, g])): ...");
        r__ = 1; goto replacement__; }
#line 93 "../../../app/willard/phase1.pcc"
} break;
    case 40: {
#line 88 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(And(_OP(_OP(redex)->_2->_1)->_2->_1,And(_OP(_OP(redex)->_2->_1)->_2->_2->_1,_OP(redex)->_2->_2->_1)),redex,Phase1_file_name,88,"OP (\"and\", #[OP (\"and\", #[a, b]), c]): ...");
        r__ = 1; goto replacement__; }
#line 93 "../../../app/willard/phase1.pcc"
} break;
    case 39: {
#line 87 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Or(_OP(_OP(redex)->_2->_1)->_2->_1,Or(_OP(_OP(redex)->_2->_1)->_2->_2->_1,_OP(redex)->_2->_2->_1)),redex,Phase1_file_name,87,"OP (\"or\", #[OP (\"or\", #[a, b]), c]): ...");
        r__ = 1; goto replacement__; }
#line 88 "../../../app/willard/phase1.pcc"
} break;
    case 38: {
#line 82 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Not(EXISTS(_FORALL(redex)->_1,_FORALL(redex)->_2,Not(_FORALL(redex)->_3))),redex,Phase1_file_name,82,"FORALL (x, A, B): ...");
        r__ = 1; goto replacement__; }
#line 87 "../../../app/willard/phase1.pcc"
} break;
    case 37: {
#line 79 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(And(Not(_OP(_OP(redex)->_2->_1)->_2->_1),Not(_OP(_OP(redex)->_2->_1)->_2->_2->_1)),redex,Phase1_file_name,79,"OP (\"not\", #[OP (\"or\", #[a, b])]): ...");
        r__ = 1; goto replacement__; }
#line 82 "../../../app/willard/phase1.pcc"
} break;
    case 36: {
#line 78 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Or(Not(_OP(_OP(redex)->_2->_1)->_2->_1),Not(_OP(_OP(redex)->_2->_1)->_2->_2->_1)),redex,Phase1_file_name,78,"OP (\"not\", #[OP (\"and\", #[a, b])]): ...");
        r__ = 1; goto replacement__; }
#line 79 "../../../app/willard/phase1.pcc"
} break;
    case 35: {
#line 77 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Or(And(_OP(redex)->_2->_1,_OP(_OP(redex)->_2->_2->_1)->_2->_1),And(_OP(redex)->_2->_1,_OP(_OP(redex)->_2->_2->_1)->_2->_2->_1)),redex,Phase1_file_name,77,"OP (\"and\", #[a, OP (\"or\", #[b, c])]): ...");
        r__ = 1; goto replacement__; }
#line 78 "../../../app/willard/phase1.pcc"
} break;
    case 34: {
#line 76 "../../../app/willard/phase1.pcc"
      { redex = DEBUG_Phase1(Or(And(_OP(_OP(redex)->_2->_1)->_2->_1,_OP(redex)->_2->_2->_1),And(_OP(_OP(redex)->_2->_1)->_2->_2->_1,_OP(redex)->_2->_2->_1)),redex,Phase1_file_name,76,"OP (\"and\", #[OP (\"or\", #[a, b]), c]): ...");
        r__ = 1; goto replacement__; }
#line 77 "../../../app/willard/phase1.pcc"
} break;
    case 33: if ((_GENERATOR(redex)->_1->_1 == _ID(_GENERATOR(redex)->_3)->ID))
    {
#line 71 "../../../app/willard/phase1.pcc"
...
#line 76 "../../../app/willard/phase1.pcc"
    ...
    {
#line 70 "../../../app/willard/phase1.pcc"
...
#line 71 "../../../app/willard/phase1.pcc"
    ...
    {
#line 65 "../../../app/willard/phase1.pcc"
...
#line 70 "../../../app/willard/phase1.pcc"
    ...
    {
#line 64 "../../../app/willard/phase1.pcc"
...
#line 65 "../../../app/willard/phase1.pcc"
    ...
    {
#line 62 "../../../app/willard/phase1.pcc"
...
#line 64 "../../../app/willard/phase1.pcc"
    ...
    {
#line 61 "../../../app/willard/phase1.pcc"
...
#line 62 "../../../app/willard/phase1.pcc"
    ...
    {
#line 60 "../../../app/willard/phase1.pcc"
...
#line 61 "../../../app/willard/phase1.pcc"
    ...
    {
#line 59 "../../../app/willard/phase1.pcc"
...
#line 60 "../../../app/willard/phase1.pcc"
    ...
    {
#line 58 "../../../app/willard/phase1.pcc"
...
#line 59 "../../../app/willard/phase1.pcc"
    ...
    {
#line 57 "../../../app/willard/phase1.pcc"
...
#line 58 "../../../app/willard/phase1.pcc"
    ...
    case 23: {
#line 55 "../../../app/willard/phase1.pcc"
...
#line 57 "../../../app/willard/phase1.pcc"
    ...
    {
#line 54 "../../../app/willard/phase1.pcc"
...
#line 55 "../../../app/willard/phase1.pcc"
    ...
    {
#line 53 "../../../app/willard/phase1.pcc"
...
#line 54 "../../../app/willard/phase1.pcc"
    ...
    {
#line 52 "../../../app/willard/phase1.pcc"
...
#line 53 "../../../app/willard/phase1.pcc"
    ...
    {
#line 51 "../../../app/willard/phase1.pcc"
...
#line 52 "../../../app/willard/phase1.pcc"
    ...
    {
#line 50 "../../../app/willard/phase1.pcc"
...
#line 51 "../../../app/willard/phase1.pcc"
    ...
    {
#line 49 "../../../app/willard/phase1.pcc"
...
#line 50 "../../../app/willard/phase1.pcc"
    ...
    {
#line 48 "../../../app/willard/phase1.pcc"
...
#line 49 "../../../app/willard/phase1.pcc"
    ...
    {
#line 47 "../../../app/willard/phase1.pcc"
...
#line 48 "../../../app/willard/phase1.pcc"
    ...
    case 14: {
#line 45 "../../../app/willard/phase1.pcc"
...
#line 47 "../../../app/willard/phase1.pcc"
    ...
    case 13: {
#line 44 "../../../app/willard/phase1.pcc"
...
#line 45 "../../../app/willard/phase1.pcc"
    ...
    case 12: {
#line 43 "../../../app/willard/phase1.pcc"
...
#line 44 "../../../app/willard/phase1.pcc"
    ...
    case 11: {
#line 42 "../../../app/willard/phase1.pcc"
...
#line 43 "../../../app/willard/phase1.pcc"
    ...
    case 10: {
#line 41 "../../../app/willard/phase1.pcc"
...
#line 42 "../../../app/willard/phase1.pcc"
    ...
    case 9: {
#line 40 "../../../app/willard/phase1.pcc"
...
#line 38 "../../../app/willard/phase1.pcc"
    ...
    case 6: {
#line 36 "../../../app/willard/phase1.pcc"
...
#line 37 "../../../app/willard/phase1.pcc"
    ...
    case 5: {
#line 34 "../../../app/willard/phase1.pcc"
...
#line 36 "../../../app/willard/phase1.pcc"
    ...
    case 4: {
#line 33 "../../../app/willard/phase1.pcc"
...
#line 34 "../../../app/willard/phase1.pcc"
    ...
    case 3: {
#line 32 "../../../app/willard/phase1.pcc"
...
#line 33 "../../../app/willard/phase1.pcc"
    ...
    case 2: {
#line 31 "../../../app/willard/phase1.pcc"
...
#line 32 "../../../app/willard/phase1.pcc"
    ...
    case 1: {
#line 30 "../../../app/willard/phase1.pcc"
...
#line 31 "../../../app/willard/phase1.pcc"
    ...
    case 0: {
#line 29 "../../../app/willard/phase1.pcc"
...
#line 97 "../../../app/willard/phase1.pcc"
#line 97 "../../../app/willard/phase1.pcc"
/* 1  *//* 2  *//* 2' */
#line 98 "../../../app/willard/phase1.pcc"
/*
------------------------------- Statistics -------------------------------
